...
## Test reference
See `tests/prompts/overlay-hook/test-001-overlay-hook-ptpt.md` for the full test brief.
...
Individual slides were not reliably produced as separate PNG files at 1080x1350px. Either the script failed partway through, slides were incomplete, or the exported files were not delivered to the user in a usable form.
...
- The 4:5 aspect ratio (420x525px at preview scale, 1080x1350px at export)
...
6. These changes should be codified in `specs/carousel-generator-v2-spec.md` and reflected in the active standalone Overlay Hook instructions
