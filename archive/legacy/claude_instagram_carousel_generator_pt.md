# 🎠 Gerador de Carrosséis do Instagram com Claude

> **Cole estas instruções em um Projeto do Claude** e o Claude vai gerar carrosséis do Instagram totalmente desenhados e consistentes com a sua marca em uma única conversa.

---

## 🚀 Como Configurar

1. Acesse [claude.ai](http://claude.ai) e clique em **"Projects"** na barra lateral esquerda
2. Crie um **New Project** e dê um nome como "Instagram Carousels"
3. Clique em **"Set project instructions"**
4. **Copie tudo o que está na caixa abaixo** e cole no campo de instruções
5. Salve e comece a gerar carrosséis dentro desse projeto
6. Não se esqueça de enviar imagens para o Claude. Ele vai incluí-las no carrossel

> 💡 O Claude vai pedir o nome da sua marca e mais algumas informações básicas

---

## 📄 Instruções do Projeto — Copie Tudo Abaixo
